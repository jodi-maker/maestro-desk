...
-- RLS matches the parent webhook table: workspace members + platform
-- admins can read deliveries. Writes go through the API/worker on
-- service-role, so the policy is read-skewed.
